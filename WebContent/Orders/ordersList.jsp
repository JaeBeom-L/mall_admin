...
<%
	...
	// 총 게시물수
	int totalRow = OrdersDao.totalRow();
	...
	Ebook e = new Ebook();
	Client c = new Client();
	ArrayList<OrdersAndEbookAndClient> list = OrdersDao.ordersList(beginRow, rowPerPage);	
%>
<!-- Page Wrapper -->
   	<div id="wrapper">
	<!-- adminMenu -->
				...
				<!-- DataTales Example -->
              	<div class="card shadow mb-4">
              		<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">ordersList</h6>
					</div>
					...
					<div class="card-body">	
						...
						<div class="table-responsive">
							...
							<!-- 페이지 이동 -->
								...
								%>
										<a href="<%=request.getContextPath()%>/Orders/ordersList.jsp?currentPage=<%=1%>&rowPerPage=<%=rowPerPage%>">
											<button type="button" class="btn btn-link">◀◀</button>
										</a>
										<a href="<%=request.getContextPath()%>/Orders/ordersList.jsp?currentPage=<%=currentPage%>&rowPerPage=<%=rowPerPage%>">
											<button type="button" class="btn btn-link">◀</button>
										</a>
