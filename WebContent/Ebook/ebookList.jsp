					...
					<div class="card-body">
						...
						<br>
                       	<div class="table-responsive">	
							...
							%>
									<a href="<%=request.getContextPath()%>/Ebook/ebookList.jsp?currentPage=<%=1%>&rowPerPage=<%=rowPerPage%>">
										<button type="button" class="btn btn-link">◀◀</button>
									</a>
									<a href="<%=request.getContextPath()%>/Ebook/ebookList.jsp?currentPage=<%=currentPage%>&rowPerPage=<%=rowPerPage%>">
										<button type="button" class="btn btn-link">◀</button>
									</a>
									<a href="<%=request.getContextPath()%>/Ebook/ebookList.jsp?currentPage=<%=currentPage+1%>&rowPerPage=<%=rowPerPage%>">
										<button type="button" class="btn btn-link">▶</button>
									</a>
									<a href="<%=request.getContextPath()%>/Ebook/ebookList.jsp?currentPage=<%=lastPage%>&rowPerPage=<%=rowPerPage%>">
										<button type="button" class="btn btn-link">▶▶</button>
									</a>
							<%
